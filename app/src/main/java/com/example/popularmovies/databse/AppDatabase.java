...
import com.example.popularmovies.databse.dao.MovieDao;
...
@Database(version = 1, entities = {Movie.class, Genre.class, Review.class, Video.class}, exportSchema = false)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    abstract public MovieDao favoriteDao();
